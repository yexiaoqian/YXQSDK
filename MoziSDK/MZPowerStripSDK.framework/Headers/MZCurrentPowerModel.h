...
@class MZCurrentPowerSubModel;
@interface MZCurrentPowerModel : MZBaseModel
@property (nonatomic, strong) MZCurrentPowerSubModel *data;
@end


@interface MZCurrentPowerSubModel : NSObject
